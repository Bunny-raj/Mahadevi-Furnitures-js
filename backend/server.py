...
SEED_PRODUCTS = [
    ...
    {"name": "Relaxwell Ortho Plus Mattress", "category": "Mattresses", "price": 8999, "featured": True,
     "description": "Relaxwell — top in our industry. Orthopedic support foam with a premium quilted top for deep, restful sleep. Available in all bed sizes.",
